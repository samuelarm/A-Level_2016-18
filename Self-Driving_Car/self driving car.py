...
def get_equal_distance(distance_front, distance_rear):
...
def get_safe_distance(current_speed, weather):
    ...
    if current_speed < 10:
        ...
        midpoint = (current_speed/10)* (VEHICLE_LENGTH / MIN_DISTANCE)
    if weather != "normal":
        mid_point = midpoint * 2
        break 
